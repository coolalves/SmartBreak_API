...
describe('test /goals', () => {
    ...
    //     });   
    // })
    // describe('goals/organization/:id', () => {
    //     it("prevent user to get a goals information if goals doesn't belong to user organization", (done) => {
    //         fetch("https://sb-api.herokuapp.com/goals/organization/" + organization_without_access + "/active", {
    //             method: "GET",
    //             headers: {
    //                 "Authorization": "Bearer " + token_with_access,
    //                 "Content-Type": "application/json"
    ...
    //             .catch((error) => done(error));
    //     });
    //     it("prevent user to get a goals information if isn't admin", (done) => {
    //         fetch("https://sb-api.herokuapp.com/goals/organization/" + organization_without_access, {
    //             method: "GET",
    //             headers: {
    //                 "Authorization": "Bearer " + token_without_access,
    //                 "Content-Type": "application/json"
    ...
    //             .catch((error) => done(error));
    //     });
    //     it("allow user to get a goals information if isn admin and goals and goals belong to user organization", (done) => {
    //         fetch("https://sb-api.herokuapp.com/goals/organization/" + organization_with_access + "/inactive", {
    //             method: "GET",
    //             headers: {
    //                 "Authorization": "Bearer " + token_with_access,
    //                 "Content-Type": "application/json"
    ...
    describe('goals/destination/:id', () => {
        ...
        //     fetch("https://sb-api.herokuapp.com/goals/destination/" + department_with_access + "/active", {
        //         method: "GET",
        //         headers: {
        //             "Authorization": "Bearer " + token_without_access,
        //             "Content-Type": "application/json"
